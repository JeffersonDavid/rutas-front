      ...
      <div>
        ...
        {user_is_logged && (
          <>
            ...
            <div className="mt-6 text-xs text-gray-400 uppercase px-2">Account</div>
          </>
        )}
      </div>
      <div className="px-2 py-4">
        {user_is_logged ? (
          <ul className="space-y-2">
            <li className="flex items-center px-2 py-2 text-gray-300 hover:bg-gray-700 rounded-md cursor-pointer" onClick={logout}>
